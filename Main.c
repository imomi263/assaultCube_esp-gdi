...
#include "Draw.h"
#include "Addresses.h"
// gcc -o AssaultCubeExternal.exe Main.c MathUtil.c Addresses.c Draw.c -lgdi32 -lmingw32 -std=c99
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    printf("PID:%lu \n", pid);
    hProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, pid); // PROCESS_ALL_ACCESS gives all access, PROCESS_VM_READ gives reading access
    ...
    //SetTimer(overlayHWND, 100, 10, (TIMERPROC)TimerProc1);
    MSG msg;
...
//void CALLBACK TimerProc1(HWND hWnd, UINT message, UINT_PTR timerId, DWORD time) {
//   updateBoxes();
//    esp();
//}
