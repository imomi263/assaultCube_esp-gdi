...
void updateEntities()
{
    ...
    //uintptr_t p_Entitycount;
    BOOL a=ReadProcessMemory(hProcess,(LPCVOID)ENTITY_COUNT,&entityCount,sizeof(int),NULL);
    for(int i=0; i<entityCount; i++) {
        ...
        ReadProcessMemory(hProcess, (LPCVOID) (entityObject + 0x00140), &armor, sizeof(int), NULL);
...
void updatePlayer()
{
    ...
    ReadProcessMemory(hProcess, (LPCVOID) (p_player + 0x00140), &pData.playerArmor, sizeof(int), NULL);
    ...
    ReadProcessMemory(hProcess, (LPCVOID) (p_player + 0x002C+0x4), &z, sizeof(float), NULL);
